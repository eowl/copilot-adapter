...
![添加提供商前的模型选择器](../resources/images/zh/add-model-step-01.png)
...
![语言模型面板及添加模型下拉菜单](../resources/images/zh/add-model-step-02.png)
...
![分组名称输入框](../resources/images/zh/add-model-step-03.png)
...
![API Key 输入框](../resources/images/zh/add-model-step-04.png)
...
![语言模型面板显示 DeepSeek 已添加](../resources/images/zh/add-model-step-05.png)
...
![模型选择器中显示 DeepSeek 模型](../resources/images/zh/add-model-step-06.png)
