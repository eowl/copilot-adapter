...
export const QWEN_BASE_MODELS: readonly ModelItem[] = [
  ...
  { ...QWEN_BASE, id: 'qwen3.6-plus', label: 'Qwen3.6 Plus', apiId: 'qwen3.6-plus', version: '3.6', maxInputTokens: 991_000, maxOutputTokens: 65_536, detailKey: 'model.qwen3.6-plus.detail' },
  { ...QWEN_BASE, id: 'qwen3.6-flash', label: 'Qwen3.6 Flash', apiId: 'qwen3.6-flash', version: '3.6', maxInputTokens: 991_000, maxOutputTokens: 65_536, detailKey: 'model.qwen3.6-flash.detail' },
  { ...QWEN_BASE, id: 'qwen3.5-plus', label: 'Qwen3.5 Plus', apiId: 'qwen3.5-plus', version: '3.5', maxInputTokens: 991_000, maxOutputTokens: 65_536, detailKey: 'model.qwen3.5-plus.detail' },
  { ...QWEN_BASE, id: 'qwen3.5-flash', label: 'Qwen3.5 Flash', apiId: 'qwen3.5-flash', version: '3.5', maxInputTokens: 991_000, maxOutputTokens: 65_536, detailKey: 'model.qwen3.5-flash.detail' },
  { ...QWEN_BASE, id: 'qwen3-max', label: 'Qwen3 Max', apiId: 'qwen3-max', version: '3', maxInputTokens: 252_000, maxOutputTokens: 65_536, detailKey: 'model.qwen3-max.detail' },
  { ...QWEN_BASE, id: 'qwen3-coder-plus', label: 'Qwen3 Coder Plus', apiId: 'qwen3-coder-plus', version: '3', maxInputTokens: 997_000, maxOutputTokens: 65_536, detailKey: 'model.qwen3-coder-plus.detail' },
