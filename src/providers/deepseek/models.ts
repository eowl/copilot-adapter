...
export const DEEPSEEK_V4_PRO: ModelItem = {
  ...
  pricing: {
    CNY: { default: { cacheInput: 0.15, input: 4.5, output: 13.5 }, longContext: { cacheInput: 0.3, input: 9, output: 27 } },
    USD: { default: { cacheInput: 0.022, input: 0.66, output: 1.98 }, longContext: { cacheInput: 0.044, input: 1.32, output: 3.96 } },
  },
...
export const DEEPSEEK_V4_FLASH: ModelItem = {
  ...
  pricing: {
    CNY: { default: { cacheInput: 0.05, input: 1.5, output: 4.5 }, longContext: { cacheInput: 0.1, input: 3, output: 9 } },
    USD: { default: { cacheInput: 0.007, input: 0.22, output: 0.66 }, longContext: { cacheInput: 0.014, input: 0.44, output: 1.32 } },
  },
  priceCategory: 'low',
};
